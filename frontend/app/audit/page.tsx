  ...
  return (
    <main className="min-h-screen bg-void flex flex-col justify-between">
      <TopNav
        ...
        rightMeta={
          reversibleCount > 0 ? (
            <span style={{ fontFamily: 'var(--font-mono)', color: '#D97706', fontSize: '11px' }}>
                      ...
                      <div className="flex flex-col gap-0.5 min-w-0">
                        <div className="flex items-center gap-2 flex-wrap">
                          <Link
                            ...
                            style={{ fontFamily: 'var(--font-sans)', color: '#A3A3A3', fontSize: '13px', textDecoration: 'none' }}
                          >
                            {action.merchant}
                          </Link>
                          <span
                            className="px-1.5 py-0.5 text-[9px] font-bold uppercase tracking-widest"
                            style={{ fontFamily: 'var(--font-sans)', color, border: `1px solid ${color}40`, borderRadius: '2px' }}
                          >
                            {action.type}
                          </span>
                          {isReversed && (
                            <span style={{ fontFamily: 'var(--font-mono)', color: '#3a3a3a', fontSize: '10px' }}>reversed</span>
                          )}
                        </div>
